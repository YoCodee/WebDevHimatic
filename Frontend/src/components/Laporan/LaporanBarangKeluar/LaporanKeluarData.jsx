...
import BarangKeluarData from "../../Chart/ChartBarangKeluar/BarangKeluarData";
import axios from "axios";

const LaporanKeluarData = () => {
        ...
        <div className="p-6 bg-gray-100 min-h-screen">
          <header className="bg-white shadow rounded-md p-4 mb-6">
            <h1 className="text-2xl font-semibold text-gray-800">
              Laporan Barang Keluar Paling Banyak
            </h1>
            <p className="text-gray-600 mt-2">
              Analisis dan visualisasi barang keluar paling banyak.
            </p>
          </header>
          ...
          <div className="bg-white shadow-md rounded-md p-6">
            <h2 className="text-lg font-medium text-gray-700 mb-4">
              Grafik Laporan Barang Keluar Paling Banyak
            </h2>
...
export default LaporanKeluarData;
