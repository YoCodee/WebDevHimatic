  ...
  const handleEditBarang = async () => {
    try {
      const response = await axios.put(
        `http://localhost:5000/api/barangKeluar/update/${barangMasukToEdit._id}`,
        formData
      );
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50 z-10">
      <div className="bg-white p-6 rounded-lg shadow-lg w-1/2">
        ...
        <div className="mb-4">
          <label className="block text-gray-700">costumer</label>
          <input
            type="text"
            name="costumer"
...
export default EditBarangKeluarModal;
